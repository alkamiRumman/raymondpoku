				...
				<?php if (isAdmin()) { ?>
					...
					<li class="nav-item">
						<a href="<?= admin_url('caregiverWeekly') ?>" class="nav-link">
							...
							<span class="link-title">Caregiver Payroll Hours</span>
						</a>
					</li>
					<li class="nav-item">
						...
						<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
							<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
								...
								<div class="text-center">
									<p class="tx-16 fw-bolder"><?= getSession()->name ?></p>
									<p class="tx-12 text-muted"><?= getSession()->username ?></p>
									<p class="tx-12 text-muted"><b>Joined Since</b>
										- <?= date('d F Y', strtotime(getSession()->createAt)) ?></p>
								</div>
							</div>
