	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title"><b>Update Client Details</b></h4>
				<button type="button" class="btn btn-danger float-end close">Close
				</button>
			</div>
			<form class="forms-sample" action="<?= admin_url('updateClient/') . $data->id ?>" method="post"
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<input type="text" class="form-control" id="referralSource" name="referralSource"
								   value="<?= $data->referralSource ?>" required>
						</div>
						<div class="col-md-3 mb-3">
							...
							<div class="input-group flatpickr">
								<input type="text" id="referralDate" name="referralDate" class="form-control"
									   value="<?= date('d M Y', strtotime($data->referralDate)) ?>" data-input required>
								<span class="input-group-text input-group-addon" data-toggle>&#128198;</span>
							</div>
						</div>
						<div class="col-md-3 mb-3">
							<label for="dol" class="form-label">DOL </label>
							<input type="text" class="form-control" id="dol"
								   value="<?= $data->dol ?>" name="dol">
						</div>
					</div>
					<div class="row">
						<div class="col-md-8 mb-3">
							...
							<input type="text" class="form-control" id="billingAddress" name="billingAddress"
								   value="<?= $data->billingAddress ?>" required>
						</div>
					...
					<div class="row">
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control" id="adjustorName" name="adjustorName"
								   value="<?= $data->adjustorName ?>" required>
						</div>
						<div class="col-md-4 mb-3">
						...
						<div class="col-md-4 mb-3">
							...
							<input type="number" class="form-control" id="adjustorPhone" name="adjustorPhone"
								   value="<?= $data->adjustorPhone ?>" required>
						</div>
						<div class="col-md-4 mb-3">
						...
						<div class="col-md-2 mb-3">
							...
							<input type="number" step="any" min="0" class="form-control" id="budgetedHours"
								   name="budgetedHours" value="<?= $data->budgetedHours ?>" readonly>
						</div>
					</div>
				</div>
