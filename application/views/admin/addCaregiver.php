	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title"><b>Add New Caregiver</b></h4>
				<button type="button" class="btn btn-danger float-end close">Close
				</button>
			</div>
			<form class="forms-sample" action="<?= admin_url('saveCaregiver') ?>" method="post"
					...
					<div class="row">
						...
						<div class="col-md-3 mb-3">
							<label for="email" class="form-label">Email <sup
										class="text-danger">*</sup></label>
							<input type="email" class="form-control" data-inputmask="'alias': 'email'" id="email" name="email" required>
						</div>
						<div class="col-md-2 mb-3">
						...
						<div class="col-md-6 mb-3">
							...
							<div class="input-group">
								<textarea rows="4" class="form-control" id="notes"
										  name="notes" placeholder="Enter your note here"></textarea>
							</div>
						</div>
					</div>
				</div>
